...
<head>
	...
	<!-- iCheck -->
	<link rel="stylesheet" href="/webjars/iCheck/skins/square/blue.css">
...
<div class="login-box" id="app">
	<div class="login-logo">
		<a href="../../index2.html"><b>GEM-View</b></a>
	</div>
	<!-- /.login-logo -->
		...
		<form id="form-login" action="/login" method="post">
			...
			<div class="row">
				...
				<div class="col-xs-4 col-xs-offset-8">
					<button type="submit" class="btn btn-primary btn-block btn-flat btn-sign">登录</button>
				</div>
				<!-- /.col -->
			</div>
		</form>
...
<!-- iCheck -->
<script src="/webjars/iCheck/icheck.js"></script>
