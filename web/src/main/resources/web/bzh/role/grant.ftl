...
<#assign css>
	<link rel="stylesheet" href="/webjars/zTree/css/zTreeStyle/zTreeStyle.css">
</#assign>
<#assign js>
<script src="/webjars/zTree/js/jquery.ztree.all.min.js"></script>
...
<script>
    ...
    $.ajax({
        type : "POST",
        url : "/permission/tree/${role.roleId}",
        dataType : 'json',
    ...
    $(".btn-submit").click(function () {
        ...
        $.ajax({
            url : "/role/grant/${role.roleId}?t=" + Math.random(),
            type : "post",
            dataType : "json",
